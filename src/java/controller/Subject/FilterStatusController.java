 ...
 * @author 84969
 */
@WebServlet(name = "FilterStatusController", urlPatterns = {"/FilterStatusController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("statusFilter") != null){
                subjectList = subDao.getSubjectByStatus(status);
            if (!subjectList.isEmpty()) {
                            request.setAttribute("listSubjects", subjectList);
                        } else {
                            request.setAttribute("message", "Not have subject!");
                        }
            } 
