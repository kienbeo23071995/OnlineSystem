 ...
 * @author KDIchigo
 */
@WebServlet(name = "SearchQuestionController", urlPatterns = {"/search-question"})
public class SearchQuestionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<QuestionL> listQuestionByKeyword = new QuestionDAO().getListQuestionByKeyword(keyword);
            ...
            request.getSession().setAttribute("listQuestion", listQuestionByKeyword);
