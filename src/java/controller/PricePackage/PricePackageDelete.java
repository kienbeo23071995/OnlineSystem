 ...
 * @author Dell
 */
@WebServlet(name = "PricePackageDelete", urlPatterns = {"/delete-pricePackage"})
...
//            dimensionDAO.deleteDimension(dimId);
//            response.sendRedirect("subject-detail?id=" + dimId);

            int priceId = Integer.parseInt(request.getParameter("priceId"));
            PricePackageDAO  pricepackDAO = new PricePackageDAO();
            pricepackDAO.deletePricePackage(priceId);
