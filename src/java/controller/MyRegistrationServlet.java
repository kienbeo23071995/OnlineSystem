...
public class MyRegistrationServlet extends HttpServlet {
    ...
    private final String SUBJECT_PAGE = "SubjectList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("account") == null) {
                ...
                List<RegistrationDTO> registrationDTOs = registrationDAO.getRegistrationByAccount(account.getUserid());
                request.setAttribute("REGISTRATION_LIST", registrationDTOs);
