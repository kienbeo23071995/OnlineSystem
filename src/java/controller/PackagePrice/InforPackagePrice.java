 ...
 * @author 84969
 */
@WebServlet(name = "InforPackagePrice", urlPatterns = {"/update_price_async"})
public class InforPackagePrice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("InforPackagePrice.jsp").forward(request, response);
    }
