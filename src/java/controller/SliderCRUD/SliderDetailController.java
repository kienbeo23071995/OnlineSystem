...
//        processRequest(request, response;
        ...
        List<Slider> listSliderById = new SliderDAO().getListSliderById(sliderId);
        Subject subject = new SubjectDAO().getSubjectById(sliderId);
        ...
        request.getRequestDispatcher("SliderJSP/SliderDetail.jsp").forward(request, response);
     }
