    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="DashboardServlet?year=${sessionScope.currentYear}">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseEight" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Custom Components:</h6>
                            <a class="collapse-item" href="regis-list">Manager Registration</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div id="collapseSeven" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Custom Components:</h6>
                            <a class="collapse-item" href="SubjectListAdmin">Manager Subject</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Custom Components:</h6>
                            <a class="collapse-item" href="quiz-list">Manager Quizzes</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Custom Components:</h6>
                            <a class="collapse-item" href="QuestionList">Manager Question</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Earnings (Annual)</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">$${requestScope.TOTAL_ALL}</div>
                                            </div>
                                            <div class="col-auto">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="text-center mb-3">
                                        <c:forEach items="${listYear}" var="Y">
                                            <a href="DashboardServlet?year=${Y.year}" class="btn btn-primary ${requestScope.yearTable == Y.year?"active":""}">${Y.year}</a>
                                        </c:forEach>
                                    </div>
                                </div>
                            </div>
...
//                , "Aug", "Sep", "Oct", "Nov", "Dec"],
                datasets: [{
                        ...
                        pointHitRadius: 10,
                        pointBorderWidth: 2,
                        data: [${requestScope.TOTAL_JANUARY}, ${requestScope.TOTAL_FEBRUARY}, ${requestScope.TOTAL_MARCH}, ${requestScope.TOTAL_APRIL}, ${requestScope.TOTAL_MAY}, ${requestScope.TOTAL_JUNE}, ${requestScope.TOTAL_JULY}],
                    }],
            },
            options: {
